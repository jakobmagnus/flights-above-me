...
export default function FlightTracker() {
    ...
    return (
        <div className="w-full h-screen grid grid-rows-[55vh_1fr] md:grid-rows-1 md:grid-cols-[1fr_380px] overflow-hidden">
            ...
            {/* Sidebar */}
            <div className={`overflow-y-auto max-h-[calc(100vh-55vh)] md:max-h-screen md:h-screen md:w-[380px] md:border-l md:border-gray-300 md:dark:border-gray-800 md:order-2 ${selectedFlight ? 'bg-gray-50 dark:bg-[#111]' : 'bg-white dark:bg-black p-5'}`}>
