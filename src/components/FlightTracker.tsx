...
export default function FlightTracker() {
    ...
    return (
        <div className="w-full h-screen grid grid-rows-[55vh_1fr] md:grid-rows-1 md:grid-cols-[1fr_380px] overflow-hidden">
            ...
            {/* Sidebar */}
            <div className={`relative flex flex-col overflow-hidden max-h-[calc(100vh-55vh)] md:max-h-screen md:h-screen md:w-[380px] md:border-l md:border-gray-300 md:dark:border-gray-800 md:order-2 ${selectedFlight ? 'bg-white dark:bg-[#111]' : 'bg-gray-100 dark:bg-black'}`}>
                {/* Scrollable content area */}
                <div className={`flex-1 overflow-y-auto ${selectedFlight ? '' : 'p-5 pb-24'}`}>
                ...
                {/* Sticky bottom action bar - only show when no flight selected */}
                {!selectedFlight && (
