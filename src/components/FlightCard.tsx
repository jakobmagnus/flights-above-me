...
function FlightCard({ flight, onClick }: FlightCardProps) {
    ...
    return (
        <button 
            type="button"
            className="bg-white dark:bg-[#111] rounded-2xl p-5 flex flex-col gap-6 w-full text-left cursor-pointer hover:bg-gray-50 dark:hover:bg-[#181818] transition-colors"
            onClick={onClick}
        >
            {/* Card Header */}
